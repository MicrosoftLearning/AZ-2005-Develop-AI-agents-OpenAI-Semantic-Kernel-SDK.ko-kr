---
title: 의미 체계 커널 및 Azure OpenAI를 사용하여 생성형 AI 솔루션 개발
permalink: index.html
layout: home
---

다음 연습은 의미 체계 커널 및 Azure OpenAI를 사용하여 생성형 AI 솔루션을 빌드할 때 개발자가 수행하는 일반적인 작업을 탐색하는 실습 학습 환경을 제공하도록 설계되었습니다.
